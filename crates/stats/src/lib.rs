...
impl TimeSeries {
    ...
    pub fn add(&mut self, time: Instant, sample: f64) {
    ...
    pub fn interval_std(&self, from: Instant, to: Instant) -> Option<f64> {
    ...
    pub fn samples(&self) -> &[(Instant, f64)] {
        &self.samples
    }
}
